const TeamMember = () => {
    ...
    <div className="bg-gray-100 min-h-screen p-8 mt-20">
      <section className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8 mb-8">
        <h1 className="text-3xl font-semibold mb-4">About Us</h1>
        <p className="text-gray-700">
          At The Journey Capturer, we're on a mission to redefine how the world experiences travel.
          We believe that travel should be a transformational journey, an exploration of not just places,
          but also of oneself.
        </p>
        <p className="text-gray-700">
          Our vision is simple yet profound: to make travel more than just a destination, but a story.
          We're here to capture the essence of every adventure, to be your storyteller, your memory keeper,
      ...
      <section className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8 mb-8">
        ...
        <ul className="list-disc list-inside text-gray-700">
          <li>Free Trips: Explore without worry with our free trips.</li>
          <li>Professional Videography: We capture every moment beautifully.</li>
          <li>Unique Experiences: Expect one-of-a-kind adventures.</li>
        </ul>
      </section>
      ...
      <section className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8">
        ...
        <p className="text-gray-700">
          We invite you to be part of our community of adventurers, storytellers, and dreamers.
          Join us on a journey of a lifetime, where every moment is captured, and every destination is a
